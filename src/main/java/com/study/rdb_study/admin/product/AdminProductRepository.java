...
public class AdminProductRepository {
    ...
    public List<AdminProductResponse> findLowStockProducts() {
        String sql = """
                select product_id, name, category, price, stock_quantity, description, status 
                from products 
    ...
    public List<AdminProductResponse> findAll() {
        String sql = "select product_id, name, category, price, stock_quantity, description, status from products";
    ...
    public Optional<AdminProductResponse> findById(Long id) {
        String sql = "select product_id, name, category, price, stock_quantity, description, status from products where product_id = ?";
