...
public class OrderRepository {
    ...
    public Order save(Order order) {
        String sql = "insert into orders (member_id, status, member_coupon_id, discount_amount, total_amount) values (?, ?, ?, ?, ?)";
    ...
    public Optional<Order> findById(Long id) {
        String sql = "select order_id, member_id, order_date, status, member_coupon_id, discount_amount, total_amount from orders where order_id=?";
    ...
    public List<Order> findByMemberId(Long id) {
        String sql = "select order_id, member_id, order_date, status, member_coupon_id, discount_amount, total_amount from orders where member_id=?";
    ...
    public List<Order> findAll() {
        String sql = "select order_id, member_id, order_date, status, member_coupon_id, discount_amount, total_amount from orders";
